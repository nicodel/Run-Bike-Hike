...
var Map = function() {
  ...
  var getMap = function(track, callback) {
    ...
    for (j = 0; j < track.data.length; j++){
      for (i = 0; i < track.data[j].length; i++) {
        point = {
          ...
          lng: track.data[j][i].longitude / 1
        };
        /*
    ...
    // map.setView([center_point.lat, center_point.lon], zoom);
    /*L.tileLayer('https://api.tiles.mapbox.com/v4/{id}/{z}/{x}/{y}.png?access_token={accessToken}', {
        attribution: 'Map data &copy; <a href="http://openstreetmap.org">OpenStreetMap</a> contributors, <a href="http://creativecommons.org/licenses/by-sa/2.0/">CC-BY-SA</a>, Imagery © <a href="http://mapbox.com">Mapbox</a>',
        maxZoom: 18,
        id: 'nicodel.f5f50fd7',
        accessToken: 'pk.eyJ1Ijoibmljb2RlbCIsImEiOiI3MzkyZDRjMTcyNTMwNDdmYzI3YjkwNjYyMzU2NTQxMCJ9.mfE8TMuIfqtdkeNzcXVXoQ'
    }).addTo(map);*/
    // L.polyline(flat_coordinates, {color: 'red'}).addTo(map);
    L.tileLayer('http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
          attribution: 'Map data &copy; <a href="http://www.osm.org">OpenStreetMap</a>',
        }).addTo(map);
    var gpx = '/home/nicodel/17936.gpx'; // URL to your GPX file or the GPX itself
